...
Completed experiment, 2026-09-01. It demonstrated that two independent LLM
command-line applications can be connected by a deterministic mediator with a
small validated control language and preserved artifacts. Further development
is closed here. Any standards-based successor should be a separate A2A
experiment rather than an expansion of this shell prototype.
